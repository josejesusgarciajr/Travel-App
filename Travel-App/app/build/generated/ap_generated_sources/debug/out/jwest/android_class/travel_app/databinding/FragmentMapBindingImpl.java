...
public class FragmentMapBindingImpl extends FragmentMapBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.mapFragment == variableId) {
            setMapFragment((jwest.android_class.travel_app.MapFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setMapFragment(@Nullable jwest.android_class.travel_app.MapFragment MapFragment) {
